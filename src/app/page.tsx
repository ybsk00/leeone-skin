            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                <Link
                  key={idx}
                  href={feature.href}
                  className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 hover:border-skin-primary/30 transition-all duration-300 hover:-translate-y-1 block"
                >
